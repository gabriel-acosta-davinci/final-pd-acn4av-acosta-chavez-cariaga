...
import useInpatientSpecialties from "../../hooks/useInpatientSpecialties.js";
import useLocalidades from "../../hooks/useLocalidades.js";
import usePlans from "../../hooks/usePlans.js";

export default function InpatientSearchForm({ onSearch, defaultPlan = "", defaultLocalidad = "" }) {
    const { specialties } = useInpatientSpecialties();
